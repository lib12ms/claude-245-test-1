...
_WESTERN_COUNTRIES: frozenset[str] = frozenset({
    ...
    "오스트리아", "폴란드", "체코", "헝가리", "루마니아", "그리스", "터키",
    "이스라엘", "이란", "인도", "호주", "캐나다", "아일랜드", "아르헨티나",
...
- **같은 저자의 여러 책 구분**: 저자의 대표작이 먼저 떠올라도, 한국어판 제목·부제의 핵심 단어를
  ...
  **메인 제목도 동일하게 적용**: 한국어 메인 제목의 핵심 의미어(주동사·핵심명사)를 영어로 직역해
  각 후보 원서 제목에 그 단어가 실제로 포함되는지 확인하라.
  예: '생각하라! 그러면 부자가 되리라' → 핵심어 '생각(think)·부자(rich)' →
  'Think and Grow Rich'는 두 핵심어 모두 포함, 'Master Key to Riches'는 'think' 없음 →
  'Think and Grow Rich'가 정답.
