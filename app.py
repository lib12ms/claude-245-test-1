...
def collect_orig_info(item: dict, item_id: str, isbn13: str, title: str, authors: list[dict], subtitle: str | None = None, category: str | None = None) -> dict:
    ...
    if not orig_title or not orig_author_en:
        ...
        gpt = _gpt_orig_info_lookup(title, authors, known_orig_author=orig_author_en, known_orig_title=_reliable_orig_title, publisher=_pub, pub_year=_year, subtitle=subtitle, category=category, author_kanji=_author_kanji)
