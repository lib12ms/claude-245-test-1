...
[생성 필드]
  ...
  710 0_  기관명 부출기입
  900 10  원저자 한글명 부출 (일본 맥락: 500 원문이 있으면 일본어 음의 한글 표기, 없거나 동일하면 245 한글; 서양만 성·이름 도치)
"""
...
def build_900(
    ...
    """
    - 일본 맥락(japanese_family_book 등): 500 원문(kanji_name)이 있으면 일본어 음을 한글로 옮긴 값이 245 한글과 다를 때만 그걸 900에 쓰고, 같거나 없으면 245와 같은 한글 표기. (성·이름 도치 없음)
