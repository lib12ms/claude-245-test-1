...
[생성 필드]
  ...
  710 0_  기관명 부출기입
  900 10  원저자 한글명 부출 (번역·원표제 CJK/가나·동아시아 플래그·또는 500 원저 한자/가나가 있으면 245와 같은 한글 표기; 그 외 서양 원저만 성·이름 도치)
"""
...
def build_900(
    ...
    """
    - 번역서(246)·원표제 CJK/가나·동아시아 플래그·또는 500에 쓰인 원저 한자/가나가 하나라도 있으면(japanese_family_book): 900은 245와 같은 한글 표기만 (성·이름 도치 없음).
